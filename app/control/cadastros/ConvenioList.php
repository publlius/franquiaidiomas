...
class ConvenioList extends TPage
{
    ...
    private static $formName = 'formList_Convenio';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de convenios");
        $this->limit = 20;
        ...
        $unidade_id->setSize('40%');

        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$id]);
        $row2 = $this->form->addFields([new TLabel("Descrição:", null, '14px', null)],[$descricao]);
        $row3 = $this->form->addFields([new TLabel("Unidade:", null, '14px', null)],[$unidade_id]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ConvenioForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('ConvenioForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ConvenioList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Convenios"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Convenio
