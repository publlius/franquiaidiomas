...
class CidadeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $estado_id = new TDBCombo('estado_id', 'cdi', 'Estado', 'id', '{id}','id asc'  );
        ...
        $row1 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null)],[$nome]);
        $row2 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$id]);
        $row3 = $this->form->addFields([new TLabel("Estado id:", '#ff0000', '14px', null)],[$estado_id]);
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Cadastro de cidade"]));
        }
