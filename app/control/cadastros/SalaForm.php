...
class SalaForm extends TPage
{
    ...
    private static $formName = 'form_Sala';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de sala");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Cadastro de sala"]));
        }
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new Sala(); // create an empty object 
            ...
            $messageAction = new TAction(['SalaForm', 'onShow']);   
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Sala($key); // instantiates the Active Record 
