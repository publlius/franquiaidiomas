...
class SalaList extends TPage
{
    ...
    private static $activeRecord = 'Sala';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Sala';
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SalaForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('SalaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SalaList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Salas"]));
        }
