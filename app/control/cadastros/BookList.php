...
class BookList extends TPage
{
    ...
    private static $activeRecord = 'Book';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Book';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de books");
        $this->limit = 20;
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['BookForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_idioma_descricao = new TDataGridColumn('idioma->descricao', "Idioma", 'left');
        ...
        $this->datagrid->addColumn($column_idioma_descricao);
        $this->datagrid->addColumn($column_descricao);

        $action_onEdit = new TDataGridAction(array('BookForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('BookList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Books"]));
        }
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->idioma_id) AND ( (is_scalar($data->idioma_id) AND $data->idioma_id !== '') OR (is_array($data->idioma_id) AND (!empty($data->idioma_id)) )) )
        {
            ...
            $filters[] = new TFilter('idioma_id', 'like', "%{$data->idioma_id}%");// create the filter 
        }
