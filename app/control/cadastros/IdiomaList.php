...
class IdiomaList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Idioma';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Idioma';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de idiomas");
        $this->limit = 20;
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['IdiomaForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('IdiomaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('IdiomaList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Idiomas"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Idioma
