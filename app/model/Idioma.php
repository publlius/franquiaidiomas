...
class Idioma extends TRecord
{
    ...
    public function getBooks()
    {
        ...
        return Book::getObjects( $criteria );
    }
    /**
    ...
    public function set_book_idioma_to_string($book_idioma_to_string)
    {
        if(is_array($book_idioma_to_string))
        {
            $values = Idioma::where('id', 'in', $book_idioma_to_string)->getIndexedArray('id', 'id');
            $this->book_idioma_to_string = implode(', ', $values);
        }
        else
        {
            $this->book_idioma_to_string = $book_idioma_to_string;
        }

        $this->vdata['book_idioma_to_string'] = $this->book_idioma_to_string;
    }

    public function get_book_idioma_to_string()
    {
        if(!empty($this->book_idioma_to_string))
        {
            return $this->book_idioma_to_string;
        }
    
        $values = Book::where('idioma_id', '=', $this->id)->getIndexedArray('idioma_id','{idioma->id}');
    ...
    public function get_curriculo_aluno_aluno_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('aluno_id','{aluno->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_curriculo_aluno_idioma_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('idioma_id','{idioma->id}');
        return implode(', ', $values);
    }
    ...
    public function get_curriculo_aluno_book_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('book_id','{book->id}');
        return implode(', ', $values);
    }
    ...
    public function get_curriculo_aluno_stage_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('stage_id','{stage->id}');
        return implode(', ', $values);
    }
    ...
    public function get_curriculo_aluno_plano_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('plano_id','{plano->id}');
        return implode(', ', $values);
    }
    ...
    public function get_curriculo_aluno_turma_to_string()
    {
        ...
        $values = CurriculoAluno::where('idioma_id', '=', $this->id)->getIndexedArray('turma_id','{turma->id}');
        return implode(', ', $values);
    }
    ...
    public function get_turma_pasta_to_string()
    {
        ...
        $values = Turma::where('idioma_id', '=', $this->id)->getIndexedArray('pasta_id','{pasta->id}');
        return implode(', ', $values);
    }
    ...
    public function get_turma_idioma_to_string()
    {
        ...
        $values = Turma::where('idioma_id', '=', $this->id)->getIndexedArray('idioma_id','{idioma->id}');
        return implode(', ', $values);
    }
    ...
    public function get_turma_book_to_string()
    {
        ...
        $values = Turma::where('idioma_id', '=', $this->id)->getIndexedArray('book_id','{book->id}');
        return implode(', ', $values);
    }
    ...
    public function get_turma_stage_to_string()
    {
        ...
        $values = Turma::where('idioma_id', '=', $this->id)->getIndexedArray('stage_id','{stage->id}');
        return implode(', ', $values);
    }
    ...
    public function get_professor_habilitacao_professor_to_string()
    {
        ...
        $values = ProfessorHabilitacao::where('idioma_id', '=', $this->id)->getIndexedArray('professor_id','{professor->id}');
        return implode(', ', $values);
    }
    ...
    public function get_professor_habilitacao_idioma_to_string()
    {
        ...
        $values = ProfessorHabilitacao::where('idioma_id', '=', $this->id)->getIndexedArray('idioma_id','{idioma->id}');
        return implode(', ', $values);
    }
    ...
    public function get_professor_habilitacao_book_to_string()
    {
        ...
        $values = ProfessorHabilitacao::where('idioma_id', '=', $this->id)->getIndexedArray('book_id','{book->id}');
        return implode(', ', $values);
    }
    ...
    public function get_professor_habilitacao_stage_to_string()
    {
        ...
        $values = ProfessorHabilitacao::where('idioma_id', '=', $this->id)->getIndexedArray('stage_id','{stage->id}');
        return implode(', ', $values);
    }
